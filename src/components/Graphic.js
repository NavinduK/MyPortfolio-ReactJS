...
const Graphic = ({ data }) => {
	...
	function galerytemp(i) {
		...
		return (
			<li
				data-aos="flip-left" data-aos-offset="-1000" data-aos-delay={`${(i * 100)}`}
	...
	return (
		<div className="container" style={{ minHeight: '100vh', marginBottom: '5vh' }}>
			<div className="demo-gallery">
				<h2 data-aos="fade-up" data-aos-duration="1300" className="text-center" style={{ marginBottom: '3vh', marginTop: '105px', fontSize: '2rem' }}>
					Graphic Design
				</h2>
